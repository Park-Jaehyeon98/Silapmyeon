...
public class OAuth2Attribute {
    ...
    private String userNickname; // 이름 정보
    private String userProfileUrl; // 프로필 사진 정보
    ...
    private static OAuth2Attribute ofGoogle(String provider, String attributeKey,
        ...
        return OAuth2Attribute.builder()
                ...
                .userProfileUrl((String) attributes.get("picture"))
                .provider(provider)
    ...
    private static OAuth2Attribute ofKakao(String provider, String attributeKey,
        ...
        return OAuth2Attribute.builder()
                ...
                .userProfileUrl((String) kakaoProfile.get("profile_image_url"))
                .provider(provider)
                .attributes(kakaoAccount)
                .attributeKey(attributeKey)
                .providerId((String) kakaoAccount.get(attributeKey))
                .build();
    }
    ...
    private static OAuth2Attribute ofNaver(String provider, String attributeKey,
        ...
        return OAuth2Attribute.builder()
                ...
                .userProfileUrl((String) response.get("profile_image"))
                .provider(provider)
                .attributes(response)
                .attributeKey(attributeKey)
