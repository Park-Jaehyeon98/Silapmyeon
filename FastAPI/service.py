...
async def tech_question():
    ...
    prompt = [
        ...
        {"role": "user", "content": "computer science 관련 질문 중 프로세스 관리, 메모리 관리, 파일 시스템, 입출력 시스템, 보안, SQL, 데이터 모델링, 트랜젝션 관리, 인덱싱, NoSQL, "
                                    "OSI 모델과 TCP/IP, 라우팅과 스위칭, 네트워크 보안, HTTP 및 웹 기술, 기본 자료구조, 정렬 알고리즘, 복잡도 분석, 트리와 그래프, CPU 구조, 메모리 계층구조, "
                                    "소프트웨어 개발 생명주기, 아키텍처 및 디자인 패턴, 소프트웨어 테스팅, 버전관리 중 무작위로 5가지를 골라 자세한 질문을 각각 100자 이내로 해주세요. "
