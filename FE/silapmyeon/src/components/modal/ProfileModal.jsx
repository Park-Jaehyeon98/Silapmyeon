            ...
            <div className={styles.modalWrap} ref={modalRef}>
                ...
                <div className={styles.contents}>
                    ...
                    <form className={styles.nickname} onSubmit={updateBtn} id="editForm">
                        닉네임 <input type="text" className={styles.input} name="userNickname" onChange={handleNickname} value={userNickname}></input>
                    </form>
                        <button className={styles.button} type="submit" form="editForm">수정하기</button>
